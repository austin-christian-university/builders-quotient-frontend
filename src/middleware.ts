...
// eslint-disable-next-line @typescript-eslint/no-unused-vars -- Next.js middleware requires the request parameter
export function middleware(_request: NextRequest) {
  ...
  const csp = [
    "default-src 'self'",
    `script-src 'self' 'unsafe-inline'${process.env.NODE_ENV === "development" ? " 'unsafe-eval'" : ""} https://*.i.posthog.com`,
